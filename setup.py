...
setup(
    ...
    name="drf_custom_method",
    # 배포할 패키지의 버전을 적어줍니다. 첫 등록이므로 0.1 또는 0.0.1을 사용합니다.
    version="0.0.1",
    # 배포할 패키지에 대한 설명을 작성합니다.
    description="drf의 action을 활용할 때, custom method를 지원하기 위해 slash를 슬래쉬(/)가 아닌 타 문자(:)로 사용할 수 있도록 커스텀 된 action 제공",
    # 배포하는 사람의 이름을 작성합니다.
    author="by-Exist",
    # 배포하는 사람의 메일주소를 작성합니다.
    author_email="bolk9652@naver.com",
    # 배포하는 패키지의 url을 적어줍니다. 보통 github 링크를 적습니다.
    url="https://github.com/by-Exist/drf-custom-method",
    # 배포하는 패키지의 다운로드 url을 적어줍니다.
    download_url="https://github.com/by-Exist/drf-custom-method/archive/master.zip",
    ...
    # 패키지의 키워드를 적습니다.
    keywords=["custom action decorator"],
